...
public class WindowInterface {
	...
	public void createWindow() {
		...
		cbPIServer.addItem("MARC-PI2016");
		...
		PISystemInfoPanel.setBorder(new TitledBorder(new EtchedBorder(), "PI System information")); // Border
																									// title
	...
	private void GetData() {
		...
		if (MyApp.isConnected == true) {
			result = MyApp.GetPIData(tfTag1.getText(), tfTag2.getText(), tfTag3.getText(), tfTag4.getText(),
					tfTag5.getText(), tfStartTime.getText(), tfEndTime.getText(), tfInterval.getText());
	...
	private void ProcessParameters() {
		...
		if (MyApp.GetRFunction() == "PI Density Plot") {
			...
			if ((cbParam1.getSelectedItem().toString() == "Grey") || (cbParam1.getSelectedItem().toString() == "Yellow")
					|| (cbParam1.getSelectedItem().toString() == "Magenta")
					|| (cbParam1.getSelectedItem().toString() == "Blue")
					|| (cbParam1.getSelectedItem().toString() == "Red")
					|| (cbParam1.getSelectedItem().toString() == "Green")
					|| (cbParam1.getSelectedItem().toString() == "Black")
					|| (cbParam1.getSelectedItem().toString() == "White")
					|| (cbParam1.getSelectedItem().toString() == "Pink")
					|| (cbParam1.getSelectedItem().toString() == "Orange")
					|| (cbParam1.getSelectedItem().toString() == "Purple")
					|| (cbParam1.getSelectedItem().toString() == "Brown")) {
			} else {
				param1 = "Red";
			}

			if ((cbParam2.getSelectedItem().toString() == "Grey") || (cbParam2.getSelectedItem().toString() == "Yellow")
					|| (cbParam2.getSelectedItem().toString() == "Magenta")
					|| (cbParam2.getSelectedItem().toString() == "Blue")
					|| (cbParam2.getSelectedItem().toString() == "Red")
					|| (cbParam2.getSelectedItem().toString() == "Green")
					|| (cbParam2.getSelectedItem().toString() == "Black")
					|| (cbParam2.getSelectedItem().toString() == "White")
					|| (cbParam2.getSelectedItem().toString() == "Pink")
					|| (cbParam2.getSelectedItem().toString() == "Orange")
					|| (cbParam2.getSelectedItem().toString() == "Purple")
					|| (cbParam2.getSelectedItem().toString() == "Brown")) {
			} else {
				param2 = "Blue";
			}
	...
	private String GenerateStringValuesOnMemory() {
		...
		if (numtags == 1) {
			...
			text = MyApp.IntCountPIValues(1) + "+" + MyApp.IntCountPIValues(2) + "+" + MyApp.IntCountPIValues(3)
					+ " values on memory.";

		} else if (numtags == 4) {
			text = MyApp.IntCountPIValues(1) + "+" + MyApp.IntCountPIValues(2) + "+" + MyApp.IntCountPIValues(3) + "+"
					+ MyApp.IntCountPIValues(4) + " values on memory.";
		} else {
			text = MyApp.IntCountPIValues(1) + "+" + MyApp.IntCountPIValues(2) + "+" + MyApp.IntCountPIValues(3) + "+"
					+ MyApp.IntCountPIValues(4) + "+" + MyApp.IntCountPIValues(5) + " values on memory.";
		}
		return (text);
	}
	...
	private void UpdateSettings() {
		...
		if (selected == "PI Histogram") {
			...
			String[] stringArray3 = new String[] { "While", "Black", "Red", "Green", "Blue", "Water Blue", "Magenta",
					"Yellow", "Gray" };
		...
		if (selected.equals("PI Density Plot")) {
			...
			String[] stringArray1 = new String[] { "Grey", "Yellow", "Magenta", "Blue", "Red", "Green", "Black",
					"White", "Pink", "Orange", "Purple", "Brown" };
			String[] stringArray2 = new String[] { "Points", "Lines", "Both", "Both overplotted", "Histogram",
					"Stair Steps" };
